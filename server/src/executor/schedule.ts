 ...
 *
 * Mirrored from the app's src/strategies/schedule.ts so the executor and the client agree to the
 * millisecond on when a run is due. Kept identical deliberately; server/src/executor/schedule.test.ts
