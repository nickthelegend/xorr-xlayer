 ...
 * result, watched on a simulator: `/asset/NVDAx` showed a live **Buy** and **Sell** pair for
 * several seconds, then replaced them with "NVDAx cannot be settled on X Layer (local fork)". The
